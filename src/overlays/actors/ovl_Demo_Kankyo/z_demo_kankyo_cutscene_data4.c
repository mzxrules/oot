...
CutsceneData gAdultWarpOutToTCS[] = {
    ...
    CS_MISC_LIST(1),
        CS_MISC_OLD(CS_MISC_STOP_CUTSCENE, 95, 96, 0x0000, 0x00000000, 0x00000000, 0xFFFFFFEE, 0xFFFFFFF3, 0x00000000, 0xFFFFFFEE, 0xFFFFFFF3, 0x00000000, 0x00000000, 0x00000000),
    CS_END(),
};
// clang-format on
