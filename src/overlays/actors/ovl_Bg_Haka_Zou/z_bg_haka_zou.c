...
void func_808828F4(BgHakaZou* this, PlayState* play) {
    ...
    for (i = 0; i < 2; i++) {
        ...
        EffectSsDust_SpawnDirt4(play, &effectPos, &effectVelocity, &sZeroVec, (Rand_ZeroOne() * 200.0f) + 1000.0f, 100);
    }
}
...
void func_80882CC4(BgHakaZou* this, PlayState* play) {
    ...
    for (i = 0; i < 3; i++) {
        for (j = 0; j < 3; j++) {
            ...
            EffectSsDust_SpawnDirt4(play, &actorSpawnPos, &sZeroVec, &sZeroVec, 1000, 50);
        }
    }
}
...
void func_80882E54(BgHakaZou* this, PlayState* play) {
    ...
    for (i = 0; i < 2; i++) {
        for (j = 0; j < 2; j++) {
            ...
            EffectSsHahen_SpawnBurst(play, &fragmentPos, 10.0f, 0, 10, 10, 4, 141, 40, gBotwBombSpotDL);
            EffectSsDust_SpawnDirt4(play, &fragmentPos, &sZeroVec, &sZeroVec, 1000, 50);
        }
    }
}
    ...
    if (Math_ScaledStepToS(&this->dyna.actor.shape.rot.x, -0x4000, this->dyna.actor.world.rot.x)) {
        ...
        for (j = 0; j < 2; j++) {
            ...
            for (i = 0; i < 4; i++) {
                ...
                EffectSsDust_SpawnDirt4(play, &effectPos, &sZeroVec, &sZeroVec, (Rand_ZeroOne() * 200.0f) + 1000.0f, 200);
            }
